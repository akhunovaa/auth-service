package com.botmasterzzz.auth.config.init;

import com.botmasterzzz.auth.config.ApplicationConfig;
import com.botmasterzzz.auth.config.SecurityConfig;
...
public class ApplicationInit implements WebApplicationInitializer {
    ...
    private static final String DISPATCHER_SERVLET_NAME = "dispatcher-auth-service";
