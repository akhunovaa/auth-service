...
import com.botmasterzzz.auth.security.*;
import com.botmasterzzz.auth.security.oauth2.CustomOAuth2UserService;
import com.botmasterzzz.auth.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/",
                        ...
                        "/**/*.js")
                .permitAll()
                .antMatchers("/**", "/oauth2/**", "/auth/oauth2/**")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
